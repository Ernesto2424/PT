...
<section class="py-5 text-center container">
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        <h1 class="fw-light">Recursos visuales</h1>
        ...
        <p>
          ...
          <a href="https://www.youtube.com/watch?v=_kkcEBG_xp0&pp=ygUocXVlIHNvbiBsb3MgcmVjdXJzb3MgdmlzdWFsZXMgaW5mYW50aWxlcw%3D%3D" target="_blank" class="btn btn-primary my-2">Hecha un vistazo!</a>
